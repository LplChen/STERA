...
>- <b>执行标准：</b>EPUB 3.0.1/XHTML 1.1/CSS 3.0/ECMAScript 5/Python 3.10/PySide6

<br/>

>## 安装方式
>-  <b>Windows：</b>下载Release里的*STERA-X*与*STERA-Std*压缩包，通过`Sigil插件→插件管理→添加插件`安装压缩包，无需解压
